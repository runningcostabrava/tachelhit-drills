...
from shorts_generator import generate_youtube_short, generate_drillplayer_demo, clip_video
...
def api_generate(type: str, drill_data: Optional[any] = None, drills_data: Optional[any] = None, 
    ...
    try:
        ...
        if type == 'short':
            ...
            # drill_data will contain {source_url, start_time, end_time}
            if not drill_data:
                return {"error": "Missing clip data"}
            res = clip_video(
                drill_data['source_url'], 
            ...
            return {"error": "Invalid type. Must be 'short' or 'demo' or 'clip'"}
